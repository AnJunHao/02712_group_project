...
from graphvelo.tangent_space import density_corrected_transition_matrix as gv_density_corrected_transition_matrix
...
def density_corrected_transition_matrix(T: NDArray[np.float64] | csr_matrix) -> csr_matrix:
